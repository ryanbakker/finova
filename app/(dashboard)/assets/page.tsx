...
function AssetsPageContent() {
  ...
  const tableRef = useRef<Table<Asset> | null>(null);
...
export default function AssetsPage() {
  // Set page title
  useEffect(() => {
    document.title = "Assets | Finova";
  }, []);

  return (
    <DynamicUpgradeOverlay
      title="Asset Management"
      description="Track your financial assets, investments, and property with detailed performance insights and analytics."
